...
- **[Awesome OpenClaw Agents](https://github.com/mergisi/awesome-openclaw-agents)** - 177 OpenClaw agent templates with MCP server configurations. Ready-to-deploy SOUL.md files that use MCP for file access, web fetch, and tool integration.
